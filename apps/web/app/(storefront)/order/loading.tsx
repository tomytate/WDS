    ...
    <main className="min-h-screen bg-[--bg-base]">
      ...
      <div className="container-shell max-w-4xl py-6 sm:py-8 lg:py-12 pb-32">
        <div className="space-y-6">
          <div className="h-10 sm:h-12 w-full rounded-xl sm:rounded-2xl border border-[--border] bg-[var(--bg-card)] animate-skeleton-pulse" />
          
          <div className="rounded-xl sm:rounded-2xl border border-[--border] bg-[var(--bg-card)] p-6 sm:p-8 space-y-6 animate-skeleton-pulse">
